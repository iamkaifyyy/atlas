    ...
    <div className="py-6 space-y-12 max-w-6xl mx-auto">
      ...
      <div className="text-center space-y-5 pt-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          <Link
            href="/terminal"
            className="flex items-center gap-2 py-3 px-6 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm transition shadow-lg shadow-blue-600/30"
          >
          ...
          <Link
            href="/automation"
            className="flex items-center gap-2 py-3 px-6 rounded-xl bg-surface-elevated hover:bg-slate-800 text-slate-200 font-semibold text-sm border border-border transition"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="glass-panel rounded-xl p-4 border border-border/70 space-y-1">
          <div className="text-[11px] font-mono text-slate-400">ON-CHAIN ESCROW</div>
          <div className="text-xl font-bold font-mono text-white">
            0.20 ETH
          </div>
        ...
        <div className="glass-panel rounded-xl p-4 border border-border/70 space-y-1">
          <div className="text-[11px] font-mono text-slate-400">24H DEX VOLUME</div>
          <div className="text-xl font-bold font-mono text-white">
        ...
        <div className="glass-panel rounded-xl p-4 border border-border/70 space-y-1">
          <div className="text-[11px] font-mono text-slate-400">MATCHING ENGINE</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
        ...
        <Link
          href="/terminal"
          className="group glass-panel rounded-2xl p-6 border border-border/80 hover:border-blue-500/60 transition duration-300 space-y-4 hover:shadow-xl hover:shadow-blue-500/10 flex flex-col justify-between"
        >
          <div className="space-y-3">
            <div className="p-3 w-fit rounded-xl bg-blue-500/10 text-blue-400 border border-blue-500/20 group-hover:scale-105 transition">
      ...
      <div className="glass-panel rounded-2xl p-6 border border-border/70 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-xs font-mono">
          <div className="bg-surface-elevated/70 p-4 rounded-xl border border-border/50 space-y-1.5 text-center">
            <div className="text-blue-400 font-bold">01. TRIGGER</div>
            <div className="text-slate-300 text-[11px]">Backpack DEX Feed</div>
          ...
          <div className="bg-surface-elevated/70 p-4 rounded-xl border border-border/50 space-y-1.5 text-center">
            ...
            <div className="text-slate-300 text-[11px]">Smart Contract Escrow</div>
            <p className="text-[10px] text-slate-500">
          ...
          <div className="bg-surface-elevated/70 p-4 rounded-xl border border-border/50 space-y-1.5 text-center">
            ...
            <div className="text-slate-300 text-[11px]">Human-in-the-Loop</div>
            <p className="text-[10px] text-slate-500">
          ...
          <div className="bg-surface-elevated/70 p-4 rounded-xl border border-border/50 space-y-1.5 text-center">
            <div className="text-indigo-400 font-bold">04. SETTLEMENT</div>
            <div className="text-slate-300 text-[11px]">Matching Engine</div>
            <p className="text-[10px] text-slate-500">
